$(document).ready(function () {
    ...
    $("#agua").click(function () {
        ...
        $("#element_description").html("<h5 id='' class='col-md-12 mb-5'><strong>Tranquilidad y Reflexión: </strong><br>" +
    ...
    $("#aire").click(function () {
        ...
        $("#element_description").html("<h5 id='' class='col-md-12 mb-5'><strong>Aventura y Libertad:  </strong><br>" +
    ...
    $("#fuego").click(function () {
        ...
        $("#element_description").html("<h5 id='' class='col-md-12 mb-5'><strong>Pasión y Energía:  </strong><br>" +
    ...
    $("#tierra").click(function () {
        ...
        $("#element_description").html("<h5 id='' class='col-md-12 mb-5'><strong>Conexión y Estabilidad:  </strong><br>" +
    ...
    $("#5elemento").click(function () {
        ...
        $("#element_description").html("<h5 id='' class='col-md-12 mb-5'><strong>Exploración y Descubrimiento:  </strong><br>" +
    ...
    $("#elementos").click(function () {
        ...
        $("#element_description").html("<h5 id='' class='col-md-12 mb-5'><strong><h2>Transforma tu elemento en experiencia con Hey Trips!</h2></strong><br>" +
